        ...
        <div className='name-details'>
          ...
          <section className='second-navbar2'>
            <div className='contact-nav2' style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', marginRight: '50px' }}>
              ...
              <img width="30" height="30" src="https://img.icons8.com/glyph-neue/64/228BE6/online-support.png" alt="online-support"/>
              ...
              <div className='online-email' style={{marginLeft:'10px'}}>
                <img width="25" height="25" src="https://img.icons8.com/ios-filled/50/228BE6/apple-mail.png" alt="apple-mail" />
        ...
        <div className='with-nav'>
          <ul id="navbar-links">
            ...
            {isLoggedIn ? (
              ...
              <>
                <a href="/Login"><button className="prescription" id='loginbtn' style={{fontSize:'14px', border:'none'}}>Login</button></a>
                <a href='/signup'><button className='prescription' id='signupbtn' style={{fontSize:'14px', border:'none'}}>Sign Up</button></a>
              </>
            )}
          </ul>
        </div>
